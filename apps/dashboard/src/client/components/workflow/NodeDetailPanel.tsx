...
export function NodeDetailPanel(props: NodeDetailPanelProps) {
  ...
  return (
    <div className="absolute right-0 top-0 z-20 flex h-full w-96 flex-col border-l border-border bg-surface-low shadow-2xl animate-in slide-in-from-right-4 duration-200">
      {/* Header */}
