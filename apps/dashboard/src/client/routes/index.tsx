        ...
        <div className="w-full max-w-md">
          ...
          <div className="rounded-lg bg-surface-low p-8 shadow-2xl glass-edge">
            <div className="space-y-8">
              ...
              <a
                href="/auth/login"
                className="group flex h-12 w-full items-center justify-center gap-3 rounded bg-discord font-semibold text-white shadow-lg transition-all duration-200 hover:opacity-90 active:scale-[0.98]"
              >
  ...
  if (guildsLoading) {
    return (
      <div className="mx-auto max-w-7xl px-6 py-12">
        ...
        <p className="text-lg text-text-muted">Loading servers...</p>
      </div>
    );
  }
    ...
    return (
      <div className="mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="flex flex-col items-center justify-center py-24 text-center">
          <h2 className="mb-2 text-2xl font-bold">No servers found.</h2>
          <p className="mb-8 text-text-muted">Make sure the bot is added to a server where you have the Manage Server permission.</p>
        </div>
      </div>
    );
  }
